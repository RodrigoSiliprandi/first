...
class EstadosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create estado" do
    assert_difference('Estado.count') do
      post estados_url, params: { estado: { idestado: @estado.idestado, nome: @estado.nome, uf: @estado.uf } }
    end
  ...
  test "should update estado" do
    patch estado_url(@estado), params: { estado: { idestado: @estado.idestado, nome: @estado.nome, uf: @estado.uf } }
