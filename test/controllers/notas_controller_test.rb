...
class NotasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create nota" do
    assert_difference('Nota.count') do
      post notas_url, params: { nota: { aluno_id: @nota.aluno_id, prova_id: @nota.prova_id, prova_livro_id: @nota.prova_livro_id, trabalho_id: @nota.trabalho_id } }
    end
  ...
  test "should update nota" do
    patch nota_url(@nota), params: { nota: { aluno_id: @nota.aluno_id, prova_id: @nota.prova_id, prova_livro_id: @nota.prova_livro_id, trabalho_id: @nota.trabalho_id } }
