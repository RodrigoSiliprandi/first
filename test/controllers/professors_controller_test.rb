...
class ProfessorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create professor" do
    assert_difference('Professor.count') do
      post professors_url, params: { professor: { documento: @professor.documento, email: @professor.email, endereco_id: @professor.endereco_id, nome: @professor.nome, telefone: @professor.telefone } }
    end
